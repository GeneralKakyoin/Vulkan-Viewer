...
pub const SECOND_LIFE_CLIENT_CHANNEL: &str = "rust-viewer";
pub const SECOND_LIFE_CLIENT_VERSION: &str = env!("CARGO_PKG_VERSION");
pub const SECOND_LIFE_PLATFORM: &str = std::env::consts::OS;
pub const SECOND_LIFE_PLATFORM_VERSION: &str = env!("CARGO_PKG_VERSION");
pub const SECOND_LIFE_HOST_ID: &str = "rust-viewer-host";
pub const SECOND_LIFE_MACHINE_HASH: &str = "rust-viewer-machine-hash";
pub const SECOND_LIFE_LOGIN_OPTIONS: &[&str] = &[
    "inventory-root",
    "inventory-skeleton",
    "buddy-list",
    "event_categories",
...
impl GridLoginAdapter for SecondLifeAdapter {
    ...
    fn shape_login_request(&self, intent: &LoginIntent) -> GridLoginRequest {
        ...
        let normalized_password = crate::legacy_login::normalize_legacy_passwd(&intent.password);
        GridLoginRequest {
